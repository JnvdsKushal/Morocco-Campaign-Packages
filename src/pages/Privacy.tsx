...
export default function Privacy() {
  ...
  const sections = t('privacy.sections') as unknown as { title: string; content: string }[];
    ...
    <div>
      <section className="pt-32 pb-16 bg-gradient-to-br from-foreground to-foreground/90">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
          <h1 className="font-serif text-4xl font-bold text-white mb-4">{t('privacy.title')}</h1>
          <p className="text-white/50 text-sm">{t('privacy.lastUpdated')}</p>
        </div>
      </section>
